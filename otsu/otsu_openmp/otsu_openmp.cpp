...
int main()
{
    ...
    auto durationAll = duration_cast<microseconds>(high_resolution_clock::now() - high_resolution_clock::now());
    auto durationstart = high_resolution_clock::now();
    ...
    for(int cur_img = 1; cur_img < 671; cur_img++) {
        ...
        durationAll += duration_cast<microseconds>(A_t1 - A_t0);
    }

    auto durationend = high_resolution_clock::now();

    // print out timing statistics
    cout << "Overall time acorss all threads: " << durationAll.count() << endl;
    cout << "True overall time: " << duration_cast<microseconds>(durationend - durationstart).count() << endl;
